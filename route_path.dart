...
class RoutePath {
  static var routes = {
    ...
    PullMergeOption.PATH: (context, {arguments}) => PullMergeOption(arguments),
    ...
    CommitFilePage.PATH: (context, {arguments}) => CommitFilePage(arguments),
    ReposWatcherPage.PATH: (context, {arguments}) => ReposWatcherPage(arguments),
    ReposForkPage.PATH: (context, {arguments}) => ReposForkPage(arguments),
    ReposStargazerPage.PATH: (context, {arguments}) => ReposStargazerPage(arguments),
